...
<Steps>
  <ol>
    ...
    <li>
      ...
      <Aside type="note">
        Replace `/absolute/path/to/private.pem` with the **absolute path** to your private key file. Use forward slashes even on Windows (e.g., `C:/Users/YourName/private.pem`).
      </Aside>
    </li>
