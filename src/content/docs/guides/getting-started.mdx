...
The Python MCP integration is the recommended way to get started, especially if you're using AI assistants like Claude Desktop or Cursor. **See it in action:** [Cursor MCP in 50 Seconds](/guides/cursor-mcp-50-second-guide/) (video + steps).
...
<Steps>
  <ol>
    ...
    <li>
      <h3>Generate Your RSA Key Pair and Register Your Public Key</h3>
      ...
      See the dedicated guide: **[Key Pairs (Public & Private)](/guides/key-pairs/)** — it covers both options (online vs. local), how to upload your public key if you generate locally, and security notes.
    </li>
